...
SELECT create_distributed_table('order_details', 'orderid', colocate_with => 'customers');
SELECT create_distributed_table('orders', 'orderid', colocate_with => 'customers');
SELECT create_distributed_table('products', 'productid');
SELECT create_distributed_table('shippers', 'shipperid');
SELECT create_distributed_table('suppliers', 'supplierid', colocate_with => 'products');
